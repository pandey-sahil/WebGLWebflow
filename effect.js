...
function DistortionEffect(globalRenderer) {
  ...
  function createMesh() {
    ...
    flowmapMesh = new THREE.Mesh(geometry, distortionMaterial);
  ...
  function update() {
    ...
    // Use the global renderer for render target operations
    const prevRenderTarget = globalRenderer.getRenderTarget();
    
    // Render flowmap
    flowmapMesh.material = flowmapMaterial;
    flowmapMaterial.uniforms.uTexture.value = flowmapB.texture;
    globalRenderer.setRenderTarget(flowmapA);
    ...
    globalRenderer.setRenderTarget(displayA);
    globalRenderer.render(scene, camera);

    // Restore previous render target
    globalRenderer.setRenderTarget(prevRenderTarget);
